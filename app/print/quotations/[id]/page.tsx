...
export default async function PrintQuotationPage({
  ...
  return (
    <>
      ...
      <div className="print-page-wrapper min-h-screen bg-gray-100 px-4 py-8">
        <div className="print-toolbar mx-auto mb-5 flex w-full max-w-[794px] items-center justify-between">
          <Link
...
function CommercialTemplate({
  ...
  return (
    <Document noPadding>
      <div className="bg-gray-900 px-[14mm] py-[12mm] text-white">
        <div className="flex items-start justify-between gap-10">
...
function QuotationTable({
  ...
  return (
    <div
      className={`avoid-break mt-8 overflow-hidden ${
        boxed
...
function BottomSection({
  ...
  return (
    <div className="avoid-break mt-9 grid gap-8 md:grid-cols-2">
      <div>
        {quotation.notes && (
          <div>
...
function SignatureSection() {
  return (
    <div className="avoid-break mt-12 grid gap-8 border-t border-gray-200 pt-8 md:grid-cols-3">
...
function Footer({
  ...
  return (
    <div className="avoid-break mt-9 border-t border-gray-200 pt-4 text-center text-xs leading-5 text-gray-400">
      <div>
...
function Document({
  ...
  return (
    ...
    id="quotation-pdf"
      ...
      className={`print-sheet overflow-hidden bg-white shadow-md ${
        noPadding
          ? ""
          : "px-[56px] py-[48px]"
      }`}
